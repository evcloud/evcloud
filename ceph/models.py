...
class CephCluster(models.Model):
    ...
    hosts_xml = models.TextField(verbose_name='ceph monitors', null=True,
                                 help_text=("设置虚机xml中disk/source元素的ceph monitors信息，"
                                            "格式:&lt;host name='10.100.50.1' port='6789'/&gt;"))
    username = models.CharField(verbose_name='ceph用户名', max_length=100, default='admin',
                                help_text="ceph用户名，需与keyring文件一致")
