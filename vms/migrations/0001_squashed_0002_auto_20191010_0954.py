    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ceph', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.CephCluster')),
        ...
        migrations.AddField(
            model_name='center',
            name='ceph_clusters',
            field=models.ManyToManyField(to='vms.CephCluster', verbose_name='存储后端'),
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ...
                ('desc', models.TextField(blank=True, default='', verbose_name='描述')),
                ('ceph_pool', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.CephPool', verbose_name='CEPH存储后端')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.Host', verbose_name='宿主机')),
                ('image', models.ForeignKey(help_text='创建此虚拟机时使用的源系统镜像，disk从image复制', on_delete=django.db.models.deletion.CASCADE, to='vms.Image', verbose_name='源镜像')),
                ('mac_ip', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ip_vm', to='vms.MacIP', verbose_name='MAC IP')),
