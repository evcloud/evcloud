    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ceph', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vms.CephBackend', verbose_name='CEPH存储后端')),
                ('host', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vms.Host', verbose_name='宿主机')),
                ('image', models.ForeignKey(help_text='创建此虚拟机时使用的源系统镜像，disk从image复制', null=True, on_delete=django.db.models.deletion.SET_NULL, to='vms.Image', verbose_name='源镜像')),
                ('mac_ip', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ip_vm', to='vms.MacIP', verbose_name='MAC IP')),
        ...
        migrations.AddField(
            model_name='macip',
            name='vlan',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='vms.Vlan', verbose_name='VLAN子网'),
        ),
        migrations.AddField(
            model_name='image',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.ImageType', verbose_name='类型'),
        ),
        migrations.AddField(
            model_name='image',
            name='xml_tpl',
            field=models.ForeignKey(help_text='使用此镜象创建虚拟机时要使用的XML模板，不同类型的镜像有不同的XML格式', on_delete=django.db.models.deletion.CASCADE, to='vms.VmXmlTemplate', verbose_name='xml模板'),
        ),
        migrations.AddField(
            model_name='host',
            name='vlans',
            field=models.ManyToManyField(to='vms.Vlan', verbose_name='VLAN子网'),
        ),
        migrations.AddField(
            model_name='cephbackend',
            name='ceph',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.CephConfig'),
        ),
        migrations.AddField(
            model_name='center',
            name='backends',
