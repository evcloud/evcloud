...
class UserRegisterForm(forms.Form):
    ...
    用户注册表单
    """
    username = forms.EmailField(label=_('用户名(邮箱)'),
                                required=True,
                                max_length=100,
                                widget=forms.EmailInput(attrs={
                                                'class': 'form-control',
                                                'placeholder': _('请输入邮箱作为用户名')
                                }))
    password = forms.CharField(label=_('密码'),
                               ...
                               widget=forms.PasswordInput(attrs={
                                                'class': 'form-control',
                                                'placeholder': _('请输入一个8-20位的密码')
                                }))
    confirm_password = forms.CharField(label=_('确认密码'),
                                       min_length=8,
                                       max_length=20,
                                       widget=forms.PasswordInput(attrs={
                                                'class': 'form-control',
                                                'placeholder': _('请输入确认密码')
                                       }))

    last_name = forms.CharField(label=_('姓氏'), max_length=30,
                                widget=forms.TextInput(attrs={
                                    'class': 'form-control',
                                    'placeholder': _('请如实填写')
                                }))

    first_name = forms.CharField(label=_('名字'), max_length=30,
                                 widget=forms.TextInput(attrs={
                                                'class': 'form-control',
                                                'placeholder': _('请如实填写')
                                            }))

    telephone = forms.CharField(label=_('电话'), max_length=11,
                                widget=forms.TextInput(attrs={
                                                'class': 'form-control',
                                                'placeholder': _('请如实填写')
                                            }))
    company = forms.CharField(label=_('公司/单位'), max_length=255,
                              widget=forms.TextInput(attrs={
                                                  'class': 'form-control',
                                                  'placeholder': _('请如实填写')
                                                }))
...
class PasswordChangeForm(forms.Form):
    ...
    用户密码修改表单
    """
    old_password = forms.CharField(label=_('原密码'),
                                   min_length=8,
                                   max_length=20,
                                   widget=forms.PasswordInput(attrs={
                                       'class': 'form-control',
                                       'placeholder': _('请输入原密码')
                                   }))
    new_password = forms.CharField(label=_('新密码'),
                                   min_length=8,
                                   max_length=20,
                                   widget=forms.PasswordInput(attrs={
                                       'class': 'form-control',
                                       'placeholder': _('请输入一个8-20位的新密码')
                                   }))
    confirm_new_password = forms.CharField(label=_('确认新密码'),
                                           min_length=8,
                                           max_length=20,
                                           widget=forms.PasswordInput(attrs={
                                               'class': 'form-control',
    ...
    def clean(self):
        ...
        if new_password != confirm_new_password or not new_password:
            raise forms.ValidationError(_('新密码输入不一致，请重新输入'))
        return self.cleaned_data
